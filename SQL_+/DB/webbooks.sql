...
-- Tiempo de generación: 14-05-2024 a las 15:55:37
...
CREATE DEFINER=`bookadmin`@`localhost` PROCEDURE `showCL` ()  BEGIN
...
CREATE TABLE `CL` (
  `isbn` char(13) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `id` mediumint UNSIGNED NOT NULL,
  `quantity` tinyint UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;

--
-- Volcado de datos para la tabla `CL`
--

INSERT INTO `CL` (`isbn`, `id`, `quantity`) VALUES
('9784567891120', 1, 5),
('9784567891120', 6, 1),
('9784567891120', 7, 1),
('9784567891177', 7, 5),
...
CREATE TABLE `credencials` (
  `usuari` char(6) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `contrassenya` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
...
CREATE TABLE `llibre` (
  `isbn` char(13) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `autor` char(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `titol` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
...
('9784567891777', 'test2', 'Estraña parejaassa', '12.00');
...
CREATE TABLE `opinio` (
  `isbn` char(13) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `id` mediumint UNSIGNED NOT NULL,
  `opinio` text CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;
